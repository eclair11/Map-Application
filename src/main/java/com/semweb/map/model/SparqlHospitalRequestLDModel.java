...
public class SparqlHospitalRequestLDModel {
    ...
    public static class Context {
        ...
        @Override
        public String toString() {
            return "Context [address=" + address + ", bedCount=" + bedCount + ", db=" + db + ", latitude=" + latitude
                    + ", longitude=" + longitude + ", mo=" + mo + ", name=" + name + ", ns=" + ns + ", picture="
                    + picture + ", rdf=" + rdf + ", wd=" + wd + ", website=" + website + ", wikipedia=" + wikipedia
